...
area100:;
	...
	$bx=pop @as;
	$ax=pop @as;
	$ax=CreateForm($ax,$bx,$cx,$dx);$EWB_v=$ax;$ax="messaggi:autore:titolo:messaggio:data";
$tot=$ax;
  $n=((split(":",$tot))[0]);
...
$form=$form."<input type=hidden name=\"EWB_Hid_FIELD\" value=\"0.359445611321465\">\
";
...
$form=$form."<input type=hidden name=\"EWB_Hid_FIELD\" value=\"0.858079063330905\">\
";
